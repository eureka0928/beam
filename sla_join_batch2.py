"""SLA-join w016-w020 (tony-017..021) to all 6 orchestrators."""
...
WORKERS = [("tony", f"tony-{i:03}") for i in range(17, 22)]  # tony-017..021
        ...
        for hname, ww in worker_wallets.items():
            ...
            for orch in ORCHS:
                ...
                if r.status_code in (200, 201):
                    ...
                    fail += 1
    print(f"\nSummary: {ok} joined, {fail} failed, {skip} skipped (of {len(WORKERS)*len(ORCHS)})")
